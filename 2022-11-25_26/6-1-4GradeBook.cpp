#include <iostream>
#include <iomanip>
#include "6-1-4GradeBook.h"
// GradeBook class definitionusing namespace std;
...
void GradeBook::displayMessage() // this statement ca1ls getCourseName to get the
{
...
void GradeBook::processGrades()
{
    ...
    // display average of a1l grades and minimum and maximum grades
